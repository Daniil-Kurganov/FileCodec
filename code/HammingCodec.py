...
string_input_text_real = 'Из точки А в точку Б вышел юноша бледный со взором горящим,'
...
string_code_word = ''.join(list_code_underwords)
print('Кодовое слово: ' + string_code_word)
int_number_code_word = int(string_code_word, 2)
print('Предстваление кодового слова: {}'.format(int_number_code_word))
print('Кодовые подслова: ')
print(list_code_underwords)
string_code_word = bin(int_number_code_word)[2:]
list_code_underwords = [string_code_word[int_current_index_of_start : int_current_index_of_start + 31] for int_current_index_of_start in range(0,
                                                                                                                   len(string_code_word), int_n)]
