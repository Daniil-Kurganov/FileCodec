...
if __name__ == '__main__':
    string_filepath_source = 'C:/Users/User/PythonProjects/FileCodec/files/ExcelFileEncode.xlsx'
    string_file_type = string_filepath_source[string_filepath_source.rfind('.') + 1:]
    string_filepath_result = string_filepath_source[:string_filepath_source.rfind('/') + 1] + 'ExcelFileDecode' + '.' + string_file_type
